...
import com.example.demo.sa.upbit.api.SA_UPBIT_QUOTATION_CANDLES_DAYS;
...
@OpService
@Service
public class BR_UPBIT_CANDLES_DAYS_SYNC {
	@Autowired
    SA_UPBIT_QUOTATION_CANDLES_DAYS saUpbitCandlesDays;
	
	@JsonRootName("IN_DS")
	@ApiModel(value="IN_DS-BR_UPBIT_CANDLES_DAYS_SYNC")
	@Data
	static class IN_DS {
		@JsonProperty("brRq")
	...
	@JsonRootName("OUT_DS")
	@ApiModel(value="OUT_DS-BR_UPBIT_CANDLES_DAYS_SYNC")
	@Data
	static class OUT_DS {
		@JsonProperty("OUT_DATA")
		@Schema(name="OUT_DATA-BR_UPBIT_CANDLES_DAYS_SYNC", description = "출력 데이터")
	...
	public OUT_DS run(@RequestBody IN_DS inDS) throws BizException {
		...
		for(int i=0;i<al.size();i++){
			...
			String to="";
			String count ="30";
			saUpbitCandlesDays.run(market, to, count);
		}		
