...
@OpService
@Service
public class BR_UPBIT_EXCHANGE_POST_WITHDRAWS_COIN {

	@Autowired
    PjtUtil pjtU;
	
	@JsonRootName("IN_DS")
	@ApiModel(value="IN_DS-BR_UPBIT_EXCHANGE_POST_WITHDRAWS_COIN")
	@Data
	static class IN_DS {
		@JsonProperty("brRq")
	...
	@ApiModel(value="IN_DATA_ROW-BR_UPBIT_EXCHANGE_POST_WITHDRAWS_COIN")
	@Data
