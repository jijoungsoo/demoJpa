...
import com.example.demo.sa.upbit.api.SA_UPBIT_EXCHANGE_GET_DEPOSITS_COIN_ADDRESSES;
...
@OpService
@Service
public class BR_UPBIT_EXCHANGE_GET_DEPOSITS_COIN_ADDRESSES {

	@Autowired
    PjtUtil pjtU;
	
	@JsonRootName("IN_DS")
	@ApiModel(value="IN_DS-BR_UPBIT_EXCHANGE_GET_DEPOSITS_COIN_ADDRESSES")
	@Data
	static class IN_DS {
		@JsonProperty("brRq")
	...
	@ApiModel(value="IN_DATA_ROW-BR_UPBIT_EXCHANGE_GET_DEPOSITS_COIN_ADDRESSES")
	@Data
	static class IN_DATA_ROW {
	}
	
	@JsonRootName("OUT_DS")
	@ApiModel(value="OUT_DS-BR_UPBIT_EXCHANGE_GET_DEPOSITS_COIN_ADDRESSES")
	@Data
	static class OUT_DS {
	...
	@ApiModel(value="OUT_DATA_ROW-BR_UPBIT_EXCHANGE_GET_DEPOSITS_COIN_ADDRESSES")
	@Data
	...
	@Autowired
	SA_UPBIT_EXCHANGE_GET_DEPOSITS_COIN_ADDRESSES saUpbitExchangeGetDepositsCoinAddresses;
	...
	public OUT_DS run(@RequestBody IN_DS inDS) throws BizException {
		...
		ArrayList<HashMap<String, Object>> al;
			try {
				al = saUpbitExchangeGetDepositsCoinAddresses.run();
