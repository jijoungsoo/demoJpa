...
@OpService
@Service
public class BR_UPBIT_MARKET_TICKER_SYNC {
	...
	@JsonRootName("IN_DS")
	@ApiModel(value="IN_DS-BR_UPBIT_MARKET_TICKER_SYNC")
	@Data
	static class IN_DS {
		@JsonProperty("brRq")
	...
	@JsonRootName("OUT_DS")
	@ApiModel(value="OUT_DS-BR_UPBIT_MARKET_TICKER_SYNC")
	@Data
	static class OUT_DS {
		@JsonProperty("OUT_DATA")
		@Schema(name="OUT_DATA-BR_UPBIT_MARKET_TICKER_SYNC", description = "출력 데이터")
	...
	public OUT_DS run(@RequestBody IN_DS inDS) throws BizException {
		...
		saUpbitMarketTicker.run(MARKETS);
