...
public class BR_STCK_BUY_RM {
	...
	@JsonRootName("IN_DS")
	@Schema(name="IN_DS",title="IN_DS-BR_STCK_BUY_RM")
	@Data
	static class IN_DS {
		@JsonProperty("brRq")
	...
	@JsonRootName("OUT_DS")
	@Schema(name="OUT_DS",title = "OUT_DS-BR_STCK_BUY_RM")
	@Data
	static class OUT_DS {
	...
	@Schema(name = "IN_DATA_ROW-BR_STCK_BUY_RM")
	@Data
	...
	@Operation(summary = "산주식 삭제.", description = "")
