...
public class BR_CM_BOARD_CMT_FIND_BY_CMT_SEQ {
	...
	static class IN_DS {
		...
		@Schema(name="IN_DATA-BR_CM_BOARD_CMT_FIND_BY_CMT_SEQ", description = "입력 데이터")
		ArrayList<IN_DATA_ROW> IN_DATA = new ArrayList<IN_DATA_ROW>();
	}

	@ApiModel(value="IN_DATA_ROW-BR_CM_BOARD_CMT_FIND_BY_CMT_SEQ")
	@Data
	...
	@JsonRootName("OUT_DS")
	@ApiModel(value="OUT_DS-BR_CM_BOARD_CMT_FIND_BY_CMT_SEQ")
	@Data
	static class OUT_DS {
		@JsonProperty("OUT_DATA")
		@Schema(name="OUT_DATA-BR_CM_BOARD_CMT_FIND_BY_CMT_SEQ", description = "출력 데이터")
		ArrayList<OUT_DATA_ROW> OUT_DATA = new ArrayList<OUT_DATA_ROW>();
	}

	@ApiModel(value="OUT_DATA_ROW-BR_CM_BOARD_CMT_FIND_BY_CMT_SEQ")
	@Data
	...
	@ApiOperation(tags={"CM_BOARD"},value = "댓글을 CMT_SEQ로 조회한다.", notes = "")
	//@PostMapping(path= "/api/BR_CM_BOARD_CMT_FIND_BY_CMT_SEQ", consumes = "application/json", produces = "application/json")
	public OUT_DS run(@RequestBody IN_DS inDS) throws BizException {
		...
		List<CmBoardCmt>  al =daBrdCmt.findBrdCmtByCmtSeq(L_CMT_SEQ);
