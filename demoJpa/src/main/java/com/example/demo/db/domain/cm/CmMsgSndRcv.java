...
@Data
@Entity
@IdClass(CmMsgSndSeqRcvSeq.class)  
@Table(name = "tb_cm_msg_snd_rcv")
//https://gangnam-americano.tistory.com/25
public class CmMsgSndRcv {
	@Id
	...
	@Column(nullable = false,length = 200, name = "rcv_tel_no")
	String rcvTelNo;
	...
	CmMsgSnd orfCmMsgSnd;

	public void setAl_cmMsgSnd(CmMsgSnd t) {
		this.orfCmMsgSnd =t;
		if(!t.getAl_cmMsgSnd().contains(this)) {
			t.getAl_cmMsgSnd().add(this);
		}
	}
}
